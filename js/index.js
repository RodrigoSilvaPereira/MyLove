...
btnComparacao.addEventListener("click", async function () {
  try {
    ...
    title.innerHTML = `<i class="fa-solid fa-arrow-left" onclick=" voltar()" style="color: #7903ff"></i> Eu Te Amo  `;
  } catch (error) {
...
btnPoema.addEventListener("click", async function () {
  try {
    ...
    //move o container texto para a visão
    title.innerHTML = `<i class="fa-solid fa-arrow-left" onclick=" voltar()" style="color: #7903ff"></i> Aqui O Poema `;
  } catch (error) {
    console.error("Erro ao buscar o texto:", error);
  }
});
...
btnElogio.addEventListener("click", async function () {
  try {
    ...
    //move o container texto para a visão
    title.innerHTML = `<i class="fa-solid fa-arrow-left" onclick=" voltar()" style="color: #7903ff"></i> Para Minha Vida `;
  } catch (error) {
    console.error("Erro ao buscar o texto:", error);
  }
});
